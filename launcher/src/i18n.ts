...
const en = {
  ...
  setupSubtitle: "Three checks prepare ChatGPT Web as a local provider runtime without taking over Codex routing.",
  ...
  stepInstall: "Configure provider runtime",
  stepInstallBody: "Prepare the local ChatGPT Web Responses endpoint. Codex routing and model catalogs are left to an external router such as OpenCodex.",
  install: "Configure provider",
  reinstall: "Repair provider runtime",
  ...
  mcpCatalogRequired: "Connect harness is unavailable until the local ChatGPT Web provider runtime is configured.",
  tunnelId: "Tunnel ID",
  ...
  launchAtLoginBody: "Keep the local Responses provider available before OpenCodex or another router needs it.",
  keepRunningOnClose: "Keep server running when window closes",
  keepRunningOnCloseBody: "Hide the launcher in the system tray so the ChatGPT Web provider remains available.",
